...
def plot_gamma_power_stop_start(prm,after_store,before_store, channel):
    ...
    print('Average gamma power : movement = ' + str(round(np.nanmean(before_store),2)) + ' +/- ' + str(round(stats.sem(before_store),2)) + ' stationary = ' + str(round(np.nanmean(before_store),2)) + ' +/- ' + str(round(stats.sem(before_store),2)))
